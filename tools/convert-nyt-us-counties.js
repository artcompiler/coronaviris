...
const FILE_IN = './data/nyt-us-counties.csv';
const FILE_OUT = 'build/data/nyt-us-counties.json';
...
function convert() {
  ...
  loadData(FILE_IN, (err, rawData) => {
    ...
    Object.keys(regions).forEach(fullName => {
      ...
      data.push({
        dataSource: ['https://github.com/nytimes/covid-19-data/blob/master/us-counties.csv'],
